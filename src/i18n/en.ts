...
export const en = {
  ...
  'composer.send': 'Send',
  'composer.previewMarkdown': 'Preview markdown',
  'composer.editMarkdown': 'Edit prompt',
  ...
  'message.quoteName': 'quoted-text.txt',
  'message.quoteOpen': 'Open quoted text',
  'message.quoteClose': 'Close quoted text',
  'message.quoteDialog': 'Quoted text preview',
  'message.annotation': '{count} annotation',
  'message.annotations': '{count} annotations',
  'message.selectedText': '{n}. Selected text:',
  ...
  'settings.reasoningEffortHint':
    'Controls the single reasoning budget sent to Grok; Auto uses the model default.',
  ...
  'settings.advancedCli': 'Advanced CLI compatibility',
  'settings.permissionMode': 'Permission mode',
  'settings.permissionModeHint':
    'Legacy CLI override; applies only when Tool permissions is Patch.',
  ...
  'settings.usagePeriodWeekly': 'Weekly quota',
  'settings.usagePeriodMonthly': 'Monthly quota',
  'settings.usagePeriodUnknown': 'Quota',
  'settings.usageQuotaRemaining': 'Quota remaining',
  'settings.usageLegendQuota': 'Quota',
  'settings.usageLegendWindow': 'Time left',
  'settings.usageQuotaUsed': '{percent} used',
  'settings.usagePaceOnTrack': 'On track',
  'settings.usagePaceOver': 'Above pace',
  'settings.usagePaceUnavailable': 'Pace unknown',
  'settings.usageResetsAt': 'Resets: {when}',
  'settings.usageResetUnavailable': 'Reset time unavailable',
  ...
  'settings.usageHistoryTitle': 'Quota History',
  'settings.usageHistoryCycle': 'Current {days}-day quota cycle',
  'settings.usageHistoryEmpty': 'Refresh to start recording this cycle.',
  'settings.usageAriaHistory': 'Quota remaining over the current cycle',
  'settings.usageAriaRings': '{quota} quota remaining; {time} of the billing window remaining',
  'settings.usageRingCaption': 'remaining',
  ...
  'sidebar.rowTitle': 'Open this conversation',
  'sidebar.menu.moreActions': 'Conversation actions',
  ...
  'message.editPromptLatestOnly': 'Only the latest completed prompt can be edited',
  ...
  'subagent.switch': 'Switch subagent',
  ...
  'subagent.railAgentCount': '{count} agents',
  'subagent.railAgentLabel': 'agents',
  'subagent.railTaskCount': '{count} tasks',
  'subagent.railTaskLabel': 'tasks',
  ...
  'notices.undoRebasedAfterAdvance':
    'Background activity moved this session forward, so Undo continued on a fresh head with your retained turns.',
  'notices.undoRewindFailed':
    'Could not rewind session; next send starts a fresh head with prior context.',
  ...
  'rules.engineControls': 'Expose Memory and Subagents as explicit engine controls',
