...
export const en = {
  ...
  'settings.usageAriaQuota': '{percent} quota remaining',
  'settings.usageAriaTime': '{percent} of the billing window remaining',
