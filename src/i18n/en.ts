...
export const en = {
  ...
  'settings.reasoningEffortHint': 'Controls the single reasoning budget sent to Grok; Auto uses the model default.',
  ...
  'settings.permissionModeHint': 'Legacy CLI override; applies only when Tool permissions is Patch.',
